...
1. Log in to Sonar, go to Quality Profiles, find the new "Text Analyser" section, and create a new profile under that
...
### Upgrade steps when moving to version 2.0.0 and above
